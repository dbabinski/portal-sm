 ...
 * @author chiefu
 */
public class RESTKlienciTest {

    public RESTKlienciTest() {
    }

    /**
     * Test of parse method, of class RESTKlienci.
     */
    @Test
    public void testParse() throws Exception {
        System.out.println("RESTKlienci.parse");
        ...
        odpowiedz = new RESTKlienci().parse(new JSONObjectExt(builder.build()), ustawieniaPacjenta);
